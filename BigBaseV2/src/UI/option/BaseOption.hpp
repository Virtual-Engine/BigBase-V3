...
namespace big::UserInterface
{
	...
	public:
		...
		const char* GetMiddleText() override
		{
			return &m_MiddleText[0];
		}
		...
		T& SetMiddleText(const char* text)
		{
			std::strncpy(&m_MiddleText[0], text, sizeof(m_MiddleText) - 1);
			return static_cast<T&>(*this);
		}
